...
# URL base del API de Roble (se pasa desde docker-compose)
ROBLE_API_URL = os.getenv("ROBLE_API_URL", "https://roble-api.openlab.uninorte.edu.co/auth/hola_9ff120e8a6")

@app.route("/")
def index():
    return jsonify({"message": "Auth Service funcionando correctamente", "roble_url": ROBLE_API_URL})
